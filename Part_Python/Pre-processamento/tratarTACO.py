...
with open('br.nham.model/Part_Python/Arquivos/taco_data_test.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
with open('br.nham.model/Part_Python/Arquivos/taco_data_test.json', 'w', encoding='utf-8') as file:
